...
module Flickr
  ...
  def put_food_image(message_event)
    http = HTTP.get("https://api.flickr.com/services/rest", params: {api_key: ENV['FLICKR_API_KEY'], method: "flickr.photos.search", text: "food #{FOOD_WORDS.sample}", license: "1,2,3,4,5,6", per_page: "20", format: "json", nojsoncallback: "1", privacy_filter: "1", content_type: "1", extras: "url_h,date_taken", sort: "relevance"})
