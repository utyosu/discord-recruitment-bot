# 募集開始キーワード
$KEYWORDS_OPEN_RECRUITMENT = /@\d+/

# 募集終了キーワード
$KEYWORDS_CLOSE_RECRUITMENT = /しめ|締め|〆|滅|sime|shime/

# 参加キーワード
$KEYWORDS_JOIN_RECRUITMENT = /いく|行く|いき|行き|やる|やりま|さんか|参加|ひゃっはー|うほ|ウホ|ごわす|ゴワス|参る|わっしょい|卍|go|join|участие|Συμμετοχή|参与|參與|참여|ပါဝင်ဆောင်ရွက်/
...
# 対話セット登録キーワード
$KEYWORDS_INTERACTION_CREATE = /記憶/

# 対話セット削除キーワード
$KEYWORDS_INTERACTION_DESTROY = /忘却/

# 対話反応キーワード
$KEYWORDS_INTERACTION_RESPONSE = /リスト/
