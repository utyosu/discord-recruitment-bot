...
module FoodPornController
  ...
  def do(message_event)
    ...
    http = HTTP.get("https://www.googleapis.com/customsearch/v1", params: {key: ENV['DISCORD_BOT_GOOGLE_API_KEY'], cx: ENV['DISCORD_BOT_GOOGLE_API_CX'], q: "飯テロ #{FOOD_WORDS.sample}", searchType: "image"})
